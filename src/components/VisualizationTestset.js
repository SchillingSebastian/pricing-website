...
export default class TestsetVisualization extends Component {
    constructor(props) {
        super(props);
        this.state = {
            stateData: null,
    ...
    render() {
        if (this.state.redirect) {
            return <Redirect push to={{pathname: "/visualization/instances", query:{instance: this.state.redirectedInstance}}} />;
        }
                    ...
                    options={{
                        onClick: (e, element) => {
                            if (element.length > 0) {
                                ...
                                console.log(instanceNames[element[0]._index])
                                this.setState({redirectedInstance: instanceNames[element[0]._index], redirect: true});
                            }
                        },
                        title: {
                        display: true,
